...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:size=12", "Noto Color Emoji:pixelsize=19:antialias=true:autohint=true"  };
static const char dmenu_font[]      = "JetBrainsMono Nerd Font:size=10";
