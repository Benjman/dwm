...
static const char *fonts[]          = { "MesloLGS NF:size=12", "Noto Color Emoji:pixelsize=19:antialias=true:autohint=true"  };
static const char dmenu_font[]      = "MesloLGS NF:size=10";
